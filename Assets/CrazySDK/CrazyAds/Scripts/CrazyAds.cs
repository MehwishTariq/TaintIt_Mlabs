...
namespace CrazyGames
{
    public class CrazyAds : Singleton<CrazyAds>
    {
        ...
        private void SimulateAdBreak(CrazyAdType adType)
        {
            ...
            Debug.Log(
                "CrazyAds: simulating ad request because we are in Editor .. game will resume in 3 seconds ..");
            ...
            ((RectTransform)panelText.transform).sizeDelta = new Vector2(600, 100);
            ...
            text.text = char.ToUpper(adTypeStr[0]) + adTypeStr.Substring(1) + " ad simulation the game will resume in 3 seconds";
            text.fontSize = 20;
            text.alignment = TextAnchor.MiddleCenter;
            text.font = Resources.GetBuiltinResource<Font>("Arial.ttf");

            panelText.transform.SetParent(simulationPanel.transform);
            simulationPanel.transform.SetParent(transform);
