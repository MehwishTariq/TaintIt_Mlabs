...
namespace CrazyGames
{
    ...
    {
        public static string sdkVersion = "4.3.0";
        public bool debug;
        ...
        [DllImport("__Internal")]
        private static extern void SendScreenshotToSDK(byte[] img, int size);
        ...
        private void SendScreenshotToSDK(byte[] img, int size) {}
        ...
        public IEnumerator GetScreenshotRoutine()
        {
            ...
            WrapGFFeature(() => { SendScreenshotToSDK(jpgImg, jpgImg.Length); });
